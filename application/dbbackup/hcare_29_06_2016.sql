...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2016 at 08:45 AM
...
--
-- Table structure for table `hspecialistdocs`
--

CREATE TABLE IF NOT EXISTS `hspecialistdocs` (
  `id` bigint(20) NOT NULL,
  `userid` bigint(20) NOT NULL,
  `licence_doc` text NOT NULL,
...
--
-- Indexes for table `hspecialistdocs`
--
ALTER TABLE `hspecialistdocs`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hspecialist`
  MODIFY `ID` bigint(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `hspecialistdocs`
--
ALTER TABLE `hspecialistdocs`
