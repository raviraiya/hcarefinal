              ...
              <tr>
                ...
                <td><div class='procedureheading'><?php echo $value['email'] ?></div></td>
                 <td><div class='procedureheading'> 
                    ...
                    <a href="#" class="changestats btn btn-info" id="statssp" spID="<?php echo $value['ID'] ?>">
                    Enable</a>
                      <?php }else{?>
                       <a href="#" class="changestats btn btn-info" id="statssp" spID="<?php echo $value['ID'] ?>">
                        Disable</a>
                  ...
                  <td>
                        ...
                        <?php if($value['licence_status'] == '1'){
                                    $dis = 'disabled';
                                    ?>
                                        <button type="button" class="verifyLicence btn btn-success" style ="background-color: #5cb85c !important;" id="checkLicence" spID="<?php echo $value['ID'] ?>" <?php echo $dis; ?>>verified</button>

                                <?php }else{
                                        $dis = '';
                                        ?>
                                        <button type="button" class="verifyLicence btn btn-info" id="checkLicence" spID="<?php echo $value['ID'] ?>" <?php echo $dis; ?>>verify</button>
                          <?php 
                                } 
                          ?>
                      </div>
                 ...
                 <td>
                     <div class='procedureheading'> 
                    <a href="#" class="adminSpEdit" id="adminSpEdit<?php echo $value['ID'] ?>" spID="<?php echo $value['ID'] ?>">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" >
                     <div class="container_padding_none" style= "margin-top:-30px">
                          <div class="content_sign_up_page_right setheight">
                            <div class="content_sign_up_page_table_right">
                              <div class="content_sign_up_page_cell_right">
                                    <div class ="centerLoder" style ="text-align: center;">
                                        <img src ="<?php echo base_url() ?>/assets/image/gif-load.gif" class ="sp-lds"> 
                                    </div>
                                    <form name ="adminaddsp" method ="post" action = "" id ="adminAddSp">
                                    ...
                                    <input placeholder="Enter password" type="password" name="password" class ="pass checkpasstype new_pass"  />
                                        ...
                                        <a href="javascript:void(0)" class="content_sign_up_submit adminaddsp" id="sregister" style ="width: 86px;">submit</a> 
                                     </form>        
                                </div>
                            </div>
                        </div>
