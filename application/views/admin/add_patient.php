...
.adminSpEdit, .changestats,.changestatsPat, .adminPatEdit{
    color:#046676;   
}
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <a href="#" class="changestatsPat btn btn-info" id="statssp" spID="<?php echo $value['ID'] ?>">
                Enable</a>
                  <?php }else{?>
                   <a href="#" class="changestatsPat btn btn-info" id="statssp" spID="<?php echo $value['ID'] ?>">
                    Disable</a>
                 ...
                 <td><div class='procedureheading'> 
                <a href="#" class="adminPatEdit" id="adminSpEdit" spID="<?php echo $value['ID'] ?>">
                          ...
                          <div class="content_sign_up_page_right setheight">
                            <div class="content_sign_up_page_table_right">
                              <div class="content_sign_up_page_cell_right">
                                ...
                                <a href="javascript:void(0)" class="content_sign_up_submit adminaddPat" id="adminaddPat" style ="width: 86px;">submit</a> 
                                </div>
                        </div>
                        </div>
                    </form>
