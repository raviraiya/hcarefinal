...
<a href="<?php echo base_url() ?>/homephysician/search_procedure?procedure_cat=<?php echo $procedure_cat_id ?>&procedure_name=<?php echo $procedure_name ?>&location=<?php echo $city ?>&zip=<?php echo $zip ?> &km=<?php echo $km ?> " class ="backbtn" style ="color: #666666 !important; float:right"><i class="fa fa-chevron-left"></i> back to list</a>
        </div>
                            ...
                            <input type ="hidden" name ="Saveslotdata"  />
                                <div class="row">
                                    <div class="col-sm-4">
                                     ...
                                     <select name ="patien_name_id"  class ="form-control showlx" id ="spat" style ="margin-bottom:20px">
                                       <option value="" selected>Select patient name</option>
                                       <?php 
                                            for( $k=0 ; $k < count($plist); $k++){?>
                                                <option value ="<?php echo $plist[$k]['userid']?>"><?php echo $plist[$k]['username']?></option>
                                            <?php 
                                                }
                                        ?>
                                     </select>
