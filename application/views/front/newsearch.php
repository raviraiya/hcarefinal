...
<div class="patient_content_right_box_border_bottom" id ="search_<?php echo $icntCOUNT?>">
    <div class="patient_content_right_box_top">
        ...
        <div class="patient_book_appointment_right">
            ...
            <p><a href="#" class="fancybox getHrsSlots" data-toggle="modal" data-search="search_<?php echo $icntCOUNT?>" data-target="#modalslots" data-pr-id = "<?php echo $search['ID'] ?>" data-dtr ="<?php echo $search['userid'] ?>" >BOOK APPOINTMENT</a></p><br>
