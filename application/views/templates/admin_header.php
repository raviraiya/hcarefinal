...
<div class="container-fluid container_padding_none">
  ...
  <div class="row">
    ...
    <div class="col-md-2 container_padding_none">
      ...
      <a href="#" class="responsive_menu">Open Menu</a> </div>
    ...
    <div class="col-md-10 container_padding_none">
      ...
      <div class="header_search_left">
        ...
        <div class="header_top_right"> <span>Welcome Dr. <?php echo $this->session->userdata("name");?></span> <img src="<?php echo base_url();?>assets/images/header_top_right_img.png" />

          <div href="#" class="header_top_right_img"><i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
...
<div class="col-md-2 container_padding_none">
  ...
  <div class="left_sidebar_border">
    ...
    <ul class="left_sidebar_menu">
      ...
      <li class="dashboard_menu_icon currentmenu"><a href="<?php echo base_url(); ?>admin">Dashboard</a></li>

      <li class="procedure_menu_icon"><a href="<?php echo base_url(); ?>admin/procedure">PROCEDURE</a></li>

      <li class="patients_menu_icon"><a href="<?php echo base_url(); ?>admin/procedurecategory">CATEGORY</a></li>

      <li class="appointments_menu_icon"><a href="<?php echo base_url(); ?>admin/appointment">APPOINTMENTS</a></li>

     <?php /*?> <li class="hospital_menu_icon"><a href="<?php echo base_url(); ?>javscript:void(0)">HOSPITAL</a></li>

      <li class="staff_menu_icon"><a href="<?php echo base_url(); ?>javscript:void(0)">STAFF</a></li><?php */?>

     <li class="hospital_menu_icon"><a href="#">SPECLIALIST</a></li>

     <li class="staff_menu_icon"><a href="<?php echo base_url(); ?>admin/homephysician">PRIMARY CARE PHYSICIAN</a></li>

      <li class="reviews_menu_icon"><a href="<?php echo base_url(); ?>javscript:void(0)">REVIEWS</a></li>
