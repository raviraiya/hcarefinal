    ...
    <div class="row">
      ...
      <div class="col-md-10 container_padding_none">
        ...
        <div class="header_search_left">
          ...
          <div class="header_top_right"> <span>Welcome Dr. <?php echo $this->session->userdata("name");?></span> <img src="<?php echo base_url();?>assets/images/header_top_right_img.png" /> <a href="#" class="header_top_right_img"><i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i></a>
