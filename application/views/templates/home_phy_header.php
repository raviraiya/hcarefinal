...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBkwgTtjZcAEBIS5e9dmUaX9MMfPpYn7w0"></script>
    ...
    <div class="row">
      ...
      <div class="col-md-2 container_padding_none">
        ...
        <div class="logo"><a href="#"> 
          ...
          <!--  <div><img src="<?php echo base_url();?>assets/hospital/original/<?php echo $this->session->userdata("hospital_logo");?>"/></div> -->

          <div><img src="<?php echo base_url();?>assets/images/logo.png"/></div>

          </a></div>

        <a href="javascript:void(0)" class="responsive_menu"></a> </div>
      ...
      <div class="col-md-10 container_padding_none">
        ...
        <div class="header_search_left">
          ...
          <div class="header_top_right"> Welcome<span class="specialist_name"> Dr. <?php echo $this->session->userdata("name");?></span> <img src="<?php echo base_url();?>assets/images/header_top_right_img.png" /> <a href="#" class="header_top_right_img"><i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i></a>
            ...
            <div class="header_top_right_menu">
              ...
              <ul>
                ...
                <li><a href="<?php echo base_url();?>homephysician/account">Account</a></li>
